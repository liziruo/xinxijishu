    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">信息技术课程线上测试系统注册</h1>
        ...
        methods: {
            ...
            login() {
                ...
                this.$http({
                    ...
                    if (data && data.code === 0) {
                    this.$message({
                        message: "注册成功,请登录后在账号中心页面补充个人数据",
                        type: "success",
                        duration: 1500,
                        onClose: () => {
...
.container {
    ...
    background-repeat: no-repeat;
        background-image: url(https://images.unsplash.com/photo-1587614382346-4ec70e388b28?q=80&w=1770&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D);
